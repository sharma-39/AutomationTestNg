...
public class CreateSuppilerTestScanerio extends LoginAndLocationTest {
    ...
    public void testSupplierCreation(String scenarioName, JsonNode supplierData, boolean expectedResult) {
        ...
        if (expectedResult) {
            Assert.assertNotNull(supplierCode, "Supplier creation failed when it was expected to pass.");
            System.out.println("Supplier created successfully: " + supplierCode);
        } else {


            // Capture and log error messages
            List<WebElement> errorMessages = getErrorMessage();
            if (!errorMessages.isEmpty()) {
                String printErrorMessage = printErrorMessage(errorMessages);
                System.out.println("All Error Messages: " + printErrorMessage);
            }
    ...
    // Helper method to check for success message
